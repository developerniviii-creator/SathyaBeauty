...
const AdminLogin = () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Swal.fire({
          ...
          icon: 'success',
          confirmButtonColor: '#D69700', // gold
          background: '#fff',
  ...
  return (
    <div className="min-h-screen bg-amber-50 flex items-center justify-center p-4 md:p-8 font-sans overflow-hidden">

      {/* Decorative Background Elements */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/20 rounded-full blur-3xl -z-0 transform translate-x-1/3 -translate-y-1/3"></div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-secondary/20 rounded-full blur-3xl -z-0 transform -translate-x-1/3 translate-y-1/3"></div>

      <motion.div
        initial={{ opacity: 0, y: 30, scale: 0.95 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="w-full max-w-5xl bg-white rounded-[40px] shadow-2xl shadow-primary/40 z-10 flex flex-col md:flex-row overflow-hidden border border-amber-100 min-h-[600px]"
      >
        {/* Left Side - Image/Branding (Hidden on mobile) */}
        <div className="hidden md:flex md:w-1/2 relative bg-gradient-to-br from-secondary to-primary p-12 flex-col justify-between overflow-hidden">
          {/* Overlay Image */}
          ...
          <div className="relative z-10">
            <div className="flex items-center space-x-3 mb-8">
              <div className="w-14 h-14 flex items-center justify-center">
                <img src={logo} alt="Sathya Beauty Logo" className="w-full h-full object-contain" />
              </div>
            ...
            >
              ...
              <p className="text-amber-50 text-lg font-medium max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/30 focus:border-primary outline-none transition-all text-gray-800 font-semibold shadow-sm"
            ...
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/admin-forgot-password" state={{ email: formData.email }} className="text-xs font-bold text-primary hover:text-secondary transition-colors">Forgot Password?</Link>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-primary transition-colors">
                  <FaLock />
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/30 focus:border-primary outline-none transition-all text-gray-800 font-semibold shadow-sm"
                  placeholder="••••••••"
                />
                <button
                  type="button"
