...
const AdminSettings = () => {
  ...
  const handleSaveSettings = () => {
    ...
    axios.put(`${import.meta.env.VITE_API_URL}/settings/`, 
      settings,
    ...
    <div className="max-w-7xl mx-auto space-y-8 font-sans pb-10 relative">
      ...
      <div className="flex flex-col lg:flex-row gap-8 relative z-10">
        ...
        <div className="lg:w-1/4">
          <div className="bg-white rounded-3xl shadow-xl shadow-amber-100/40 border border-amber-100 overflow-hidden sticky top-24">
            <nav className="flex flex-col p-4 space-y-2">
              <button 
                onClick={() => setActiveTab('general')}
                className={`flex items-center px-4 py-3 rounded-xl transition-colors font-bold ${activeTab === 'general' ? 'bg-amber-50 text-primary' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800'}`}
              >
                <FaStore className={`mr-3 ${activeTab === 'general' ? 'text-primary' : 'text-gray-400'}`} /> General Settings
              </button>
              <button 
                onClick={() => setActiveTab('profile')}
                className={`flex items-center px-4 py-3 rounded-xl transition-colors font-bold ${activeTab === 'profile' ? 'bg-amber-50 text-primary' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800'}`}
              >
                <FaUserEdit className={`mr-3 ${activeTab === 'profile' ? 'text-primary' : 'text-gray-400'}`} /> Admin Profile
              </button>
              <button 
                onClick={() => setActiveTab('notifications')}
                className={`flex items-center px-4 py-3 rounded-xl transition-colors font-bold ${activeTab === 'notifications' ? 'bg-amber-50 text-primary' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800'}`}
              >
                <FaBell className={`mr-3 ${activeTab === 'notifications' ? 'text-primary' : 'text-gray-400'}`} /> Notifications
              </button>
              <button 
                onClick={() => setActiveTab('appearance')}
                className={`flex items-center px-4 py-3 rounded-xl transition-colors font-bold ${activeTab === 'appearance' ? 'bg-amber-50 text-primary' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800'}`}
              >
                <FaPalette className={`mr-3 ${activeTab === 'appearance' ? 'text-primary' : 'text-gray-400'}`} /> Appearance
              </button>
              <button 
                onClick={() => setActiveTab('security')}
                className={`flex items-center px-4 py-3 rounded-xl transition-colors font-bold ${activeTab === 'security' ? 'bg-amber-50 text-primary' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800'}`}
              >
                <FaShieldAlt className={`mr-3 ${activeTab === 'security' ? 'text-primary' : 'text-gray-400'}`} /> Security
              </button>
            </nav>
          </div>
        </div>
        ...
        <div className="lg:w-3/4">
          <motion.div 
            ...
            className="bg-white rounded-3xl shadow-xl shadow-amber-100/40 border border-amber-100 p-8 min-h-[500px]"
          >
            {activeTab === 'general' && (
              <div>
                ...
                <form className="space-y-6 max-w-2xl">
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" value={settings.parlour_name} onChange={(e) => handleSettingChange('parlour_name', e.target.value)} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all text-gray-800 font-semibold shadow-sm" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all resize-none text-gray-800 font-medium shadow-sm"
                    ></textarea>
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Currency</label>
                    <select value={settings.currency} onChange={(e) => handleSettingChange('currency', e.target.value)} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all text-gray-800 font-bold shadow-sm">
                  ...
                  <div className="pt-4">
                    <button type="button" onClick={handleSaveSettings} className="bg-primary hover:bg-secondary text-white px-8 py-3.5 rounded-xl font-bold flex items-center transition-colors shadow-md shadow-primary/30 transform hover:-translate-y-0.5">
            ...
            {activeTab === 'profile' && (
              <div>
                ...
                <div className="flex items-center mb-8 bg-amber-50/50 p-6 rounded-2xl border border-amber-100">
                ...
                <form className="space-y-6 max-w-2xl">
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" defaultValue="Admin" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all text-gray-800 font-semibold shadow-sm" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2">Last Name</label>
                      <input type="text" defaultValue="User" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all text-gray-800 font-semibold shadow-sm" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Email Address</label>
                    <input type="email" defaultValue="admin@sathyabeauty.com" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all text-gray-800 font-semibold shadow-sm" />
                  </div>
                  <div className="pt-4">
                    <button type="button" className="bg-primary hover:bg-secondary text-white px-8 py-3.5 rounded-xl font-bold flex items-center transition-colors shadow-md shadow-primary/30 transform hover:-translate-y-0.5">
            ...
            {activeTab === 'notifications' && (
              <div>
                ...
                <div className="space-y-4 max-w-2xl mb-8">
                  <div className="flex items-center justify-between p-5 bg-gray-50 hover:bg-amber-50/50 transition-colors rounded-2xl border border-gray-100">
                    <div>
              ...
              <div>
                ...
                <form className="space-y-6 max-w-2xl">
                  <div>
                    ...
                    <input type="password" placeholder="••••••••" className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all shadow-sm text-gray-800" />
                  </div>
                  <div className="grid grid-cols-2 gap-6">
                    <div>
